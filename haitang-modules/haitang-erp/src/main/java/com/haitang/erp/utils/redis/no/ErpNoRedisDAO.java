package com.haitang.erp.utils.redis.no;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import com.haitang.erp.utils.redis.RedisKeyConstants;
...
public class ErpNoRedisDAO {
     ...
     */
    public static final String STOCK_OUT_NO_PREFIX = "QTCK";
    ...
    /**
     * 采购订单 {@link com.haitang.erp.domain.purchase.ErpPurchaseOrder}
     */
